...
class Food:
    ...
    and keep amount, category, and macros in it."""
    ...
    def __init__(self, name, macros_df):
        ...
        """
        self.name = name
        self.category = macros_df[macros_df['food']==name]['category'].item()
        self.amount = 0
...
def promptTreat(macros, targetMacros):
    ...
    while True:
          ...
          for treat in macros[macros['category']=='treat']['food']:
               print("- " + treat) 
          print('- (done)')
          choice = input("Answer: ")
          if choice in treatChoice:
               ...
               break
          elif choice not in macros[macros['category']=='treat']['food'].values:
               print("Treats not found! Please type the correct treats!")
          elif choice in macros[macros['category']=='treat']['food'].values:
